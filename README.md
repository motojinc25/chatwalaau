...
| **Harness agents** | Run autonomous coding agents with planning, todo lists, session memory, workspace-scoped file and shell access, Skills, and context compaction -- uninterrupted by approval prompts. |
