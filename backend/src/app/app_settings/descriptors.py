...
DESCRIPTORS: tuple[SettingDescriptor, ...] = (
    ...
    # ---- Speech: GPT-Live (runtime -- read at each session creation) -------
    # PRP-0188 / UDR-0170 D7 / D8. The Live model itself is a `live` offering in the
    # Model Offering Catalog (step 2, D11), so it has no setting here.
    SettingDescriptor(
        "gpt_live_voice",
        "Live voice",
        "speech",
        ...
        help="The voice GPT-Live speaks with. Applies to the next Live conversation.",
    ),
    SettingDescriptor(
        "gpt_live_max_session_seconds",
        "Live session limit (seconds)",
        "speech",
        "int",
        SCOPE_RUNTIME,
        min=60,
        max=3600,
        help="A Live conversation is closed after this long; a warning appears one minute before.",
    ),
    SettingDescriptor(
        "gpt_live_idle_timeout_seconds",
        "Live silence timeout (seconds)",
        "speech",
        "int",
        SCOPE_RUNTIME,
        min=15,
        max=600,
        help="A Live conversation is closed after this much silence from both sides.",
    ),
    SettingDescriptor(
        "gpt_live_delegation_timeout_seconds",
        "Live delegation timeout (seconds)",
        "speech",
        "int",
        SCOPE_RUNTIME,
        min=10,
        max=600,
        help="Upper bound for one agent run started by the Live voice.",
    ),
